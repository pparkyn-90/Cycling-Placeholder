...
export default function Home() {
  ...
  return (
    <>
      ...
      <div style={{ background: 'url(https://images.unsplash.com/photo-1508779018996-4a005eadd9a6) center/cover no-repeat', height: '300px', color: 'white', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '2rem', fontWeight: 'bold' }}>
        Cycle Deals
      </div>
